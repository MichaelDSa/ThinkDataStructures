...
public class MyArrayList<T> implements List<T> {
	...
	public boolean add(T element) {
		...
		if (size >= array.length) {
			T[] arrayLengthDoubled = (T[]) new Object[array.length * 2];
			System.arraycopy(array,0,arrayLengthDoubled,0, array.length);
	...
	public T set(int index, T element) {
		// TODO: FILL THIS IN!
		T oldValue = get(index); // previous value is stored, get() checks if index is within size of array
		array[index] = element; // previous value is replaced
		return oldValue; // the element previously at specified position is returned.
	}
