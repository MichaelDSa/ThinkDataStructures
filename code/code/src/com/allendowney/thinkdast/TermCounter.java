...
//		for (int i : map.values()) { //This is the official solution
//			sum += i;
//		}
		...
		// can also return this.sum, if instance variable and counter (in .incrementTermCount() is uncommented.;
		return sum;
	}
	...
	public void incrementTermCount(String term) {
		...
		put(term, get(term) + 1);
//		this.sum += 1;//Total number of all term instances
	}
...
//		Elements paragraphs = new WikiFetcher().fetchWikipedia(url);//this does not ensure single instantiation.
